...
const camera = {
    ...
    targetY: 0,
    smoothing: 0.1,
    offsetX: 300, // Keep player this distance from left edge
    offsetY: 0
};
...
const platforms = [
    ...
    { x: 800, y: 550, width: 400, height: 50, type: 'ground' },
    { x: 1400, y: 550, width: 600, height: 50, type: 'ground' },
    { x: 2200, y: 550, width: 400, height: 50, type: 'ground' },
    { x: 2800, y: 550, width: 400, height: 50, type: 'ground' },
    
    // Mid-level platforms
    { x: 600, y: 450, width: 200, height: 20, type: 'platform' },
    { x: 1000, y: 400, width: 300, height: 20, type: 'platform' },
    { x: 1600, y: 350, width: 200, height: 20, type: 'platform' },
    { x: 2000, y: 400, width: 250, height: 20, type: 'platform' },
    { x: 2500, y: 300, width: 200, height: 20, type: 'platform' },
    
    // Upper platforms
    { x: 800, y: 250, width: 150, height: 20, type: 'platform' },
    { x: 1200, y: 200, width: 180, height: 20, type: 'platform' },
    { x: 1800, y: 200, width: 150, height: 20, type: 'platform' },
    { x: 2300, y: 150, width: 200, height: 20, type: 'platform' }
];
...
const enemySpawner = {
    ...
    maxEnemies: 6, // Increased for larger level
    spawnLocations: [
        { x: 600, type: 'car' },
...
const collectibleSpawner = {
    ...
    maxCollectibles: 5, // Increased for larger level
    spawnLocations: [
        { x: 700, y: 430, type: 'dumpling' },    // On mid-level platform
        { x: 1150, y: 380, type: 'noodle_soup' }, // On mid-level platform  
        { x: 1700, y: 330, type: 'dumpling' },   // On upper platform
        { x: 2125, y: 380, type: 'noodle_soup' }, // On mid-level platform
        { x: 2600, y: 280, type: 'dumpling' },   // On upper platform
        { x: 875, y: 230, type: 'noodle_soup' }, // On high platform
        { x: 1300, y: 180, type: 'dumpling' },   // On highest platform
        { x: 2400, y: 130, type: 'noodle_soup' } // On highest platform
    ],
    currentSpawnIndex: 0
};
...
function update(deltaTime) {
    ...
    if (player.x >= GAME_CONFIG.LEVEL_END_X) {
        // Level completed! For now, just show in debug
        console.log('Level completed!');
        // Could add level completion screen here
    }
...
function drawDebugInfo() {
    ...
    // Camera system
    ctx.fillText(`Camera: (${Math.round(camera.x)}, ${Math.round(camera.y)})`, 10, 335);
    ctx.fillText(`Level Progress: ${Math.round((player.x / GAME_CONFIG.LEVEL_END_X) * 100)}%`, 10, 350);
