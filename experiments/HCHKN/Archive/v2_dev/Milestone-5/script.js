...
function playBackgroundMelody(theme, tempo) {
    ...
    try {
        ...
        setTimeout(() => {
            if (audioSystem.backgroundMusic.currentTrack === theme) {
...
function drawDebugInfo() {
    ...
    ctx.fillText(`Current Track: ${audioSystem.backgroundMusic.currentTrack || 'None'} | Audio Context: ${audioSystem.audioContext ? audioSystem.audioContext.state : 'Not Available'}`, 10, 410);
